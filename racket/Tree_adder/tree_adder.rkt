...
;(display "\n")
;(illu input_tree)
(tree_sumation (node 1 empty empty))
(display "\n")
(tree_sumation (node 1 (node 2 empty empty) (node 3 (node 4 empty empty) empty)))
(display "\n")
(tree_sumation (node 1 (node 2 (node 3 empty empty) (node 1 empty empty)) (node 13 (node 14 empty empty) (node 17 empty empty))))
(display "\n")